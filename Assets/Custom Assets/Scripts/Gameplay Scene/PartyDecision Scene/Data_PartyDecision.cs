...
public class Data_PartyDecision : MonoBehaviour
{
    ...
    void GenerateRandomUnitCardsData(DataManager_Gameplay dataManager_Cp_tp)
    {
        ...
        playersUnitCardsData = dataManager_Cp_tp.playersUnitCardsData.ToArray();
    }
    ...
    {
        dataManager_Cp.playersVanUnitCardsData.Clear();
        for (int i = 0; i < cardsManager_Cps.Count; i++)
        {
            ...
            {
                dataManager_Cp.playersVanUnitCardsData[i].unitCards.Add(
                    dataManager_Cp.GetUnitCardDataFromCardIndex(vanUnit_Cps_tp[i].cardIndex));
            }

            dataManager_Cp.playersVanUnitCardsData[i].playerID = cardsManager_Cps[i].playerID;
        }

        dataManager_Cp.playersRearUnitCardsData.Clear();
        for (int i = 0; i < cardsManager_Cps.Count; i++)
        {
            ...
            {
                dataManager_Cp.playersRearUnitCardsData[i].unitCards.Add(
                    dataManager_Cp.GetUnitCardDataFromCardIndex(rearUnit_Cps_tp[i].cardIndex));
            }

            dataManager_Cp.playersRearUnitCardsData[i].playerID = cardsManager_Cps[i].playerID;
        }
